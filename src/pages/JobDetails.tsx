  ...
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      <SEOHead
        ...
        keywords={[job.title, job.company, job.category]}
        section="Jobs"
      />
      <Header />
            ...
            <div className="space-y-6">
              <Card className="p-6 border-border/40 bg-card/40 backdrop-blur-sm sticky top-24 animate-slide-up stagger-1">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Please mention that you found this job on Perspective when applying.
                </p>
                <Button className="w-full rounded-full py-6 text-base font-medium neon-button group">
                  Apply Now
