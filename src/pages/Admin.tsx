...
import { PlusCircle, Save, Eye, Trash2, Lock, Edit2, ArrowLeft, Upload, Image as ImageIcon, FolderOpen, Tag, BarChart3, Briefcase, User, KeyRound, AppWindow } from "lucide-react";
...
import { AutoAdsInfo } from "@/components/admin/AutoAdsInfo";
...
export function Admin() {
      ...
      try {
        ...
        if (token) {
          ...
          if (valid) {
            ...
            setCurrentAdmin({ id: 'admin-1', username: 'admin', role: 'admin' });
          } else {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: 'featured' | 'author' | 'og' = 'featured') => {
  ...
  if (!isAuthenticated) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-2xl border-slate-800 overflow-hidden">
          ...
          <CardContent className="space-y-5 pb-8">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="bg-slate-900/50 border-slate-700 pl-10 focus:border-primary focus:ring-primary/20 transition-all"
                  autoComplete="username"
                  autoFocus
                />
              </div>
            ...
            <Button onClick={() => navigate("/")} variant="outline" className="w-full border-slate-700 hover:bg-slate-800 transition-colors">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Site
            </Button>
          </CardContent>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-white flex items-center gap-1">
                <span className="bg-gradient-to-r from-primary to-purple-400 bg-clip-text text-transparent">Algojua</span>
            ...
            <div className="flex items-center gap-3 pl-3 border-l border-slate-700">
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-800/50 border border-slate-700">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-medium text-white">{currentAdmin?.username || 'admin'}</p>
                  <p className="text-xs text-slate-500">{currentAdmin?.role || 'Administrator'}</p>
                </div>
              </div>
              <Button
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="dashboard" className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {/* Posts Card */}
              <Card className="border-slate-800 bg-gradient-to-br from-slate-900 to-slate-900/50 hover:border-slate-700 transition-all group overflow-hidden relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <CardContent className="p-6 relative">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-sm font-medium text-slate-400">Total Posts</p>
                      <p className="text-4xl font-bold mt-2 bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
                        {posts.length}
                      </p>
                      <p className="text-xs text-slate-500 mt-2">Published articles</p>
                    </div>
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="mt-4 w-full text-blue-400 hover:text-blue-300 hover:bg-blue-500/10"
                  >
                    <PlusCircle className="w-4 h-4 mr-2" />
                    Create Post
                  </Button>
                ...
                <CardContent className="p-6 relative">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-bold mt-2 bg-gradient-to-r from-green-400 to-emerald-600 bg-clip-text text-transparent">
                        {jobs.length}
                      </p>
                      <p className="text-xs text-slate-500 mt-2">Job listings</p>
                    </div>
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="mt-4 w-full text-green-400 hover:text-green-300 hover:bg-green-500/10"
                  >
                    <Briefcase className="w-4 h-4 mr-2" />
                    Manage Jobs
                  </Button>
                ...
                <CardContent className="p-6 relative">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-bold mt-2 bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">
                        {categories.length}
                      </p>
                      <p className="text-xs text-slate-500 mt-2">Content categories</p>
                    </div>
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="mt-4 w-full text-purple-400 hover:text-purple-300 hover:bg-purple-500/10"
                  >
                    <Tag className="w-4 h-4 mr-2" />
                    Manage Categories
                  </Button>
                ...
                <CardContent className="p-6 relative">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-4xl font-bold mt-2 bg-gradient-to-r from-orange-400 to-amber-600 bg-clip-text text-transparent">
                        {media.length}
                      </p>
                      <p className="text-xs text-slate-500 mt-2">Images in library</p>
                    </div>
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="mt-4 w-full text-orange-400 hover:text-orange-300 hover:bg-orange-500/10"
                  >
          ...
          <TabsContent value="ads" className="space-y-4">
            <Card className="border-slate-800 bg-slate-900/50">
              <CardHeader>
                ...
                <CardDescription>Google AdSense Auto Ads</CardDescription>
              </CardHeader>
              <CardContent>
                <AutoAdsInfo />
              </CardContent>
